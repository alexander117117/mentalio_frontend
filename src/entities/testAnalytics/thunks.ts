...
interface createAsyncThunkParams {
  idTopic: Id
  answers: TestAnswer[]
}
...
export const saveResultTestThunks = createAsyncThunk<void, createAsyncThunkParams, { rejectValue: string }>(
  'testAnalytics/saveResultTestThunks',
  async ({ idTopic, answers }, api) => {
