...
type FolderDirectoryProps = Pick<CardFolderItemWithUserName, 'name' | 'description' | 'userName'>

export function DirectoryContent({ name, description, userName }: FolderDirectoryProps) {
  return (
    <>
