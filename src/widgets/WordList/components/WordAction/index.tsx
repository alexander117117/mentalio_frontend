...
interface WordActionProps{favorite?: boolean}
export function WordAction({ favorite=false }: WordActionProps){
  return (
    <div className={style.word_group_action}>
      ...
      <img src={favorite ? favorite_word_mark_icon : favorite_word_icon} alt="Любимое Слово" className="cursor-pointer w-[24px] sm:w-auto"/>
